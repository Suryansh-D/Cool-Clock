...
let clockInterval; // Store the interval for pausing/resuming

function stopClock() {
    clearInterval(clockInterval); // Clear the interval to pause
}

stopButton.addEventListener('click', stopClock);

function startClock() {
    clockInterval = setInterval(clockTick, 1000); // Start the interval
}
