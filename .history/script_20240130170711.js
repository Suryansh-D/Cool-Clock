...
let rotateClockHand; // Define the variable outside the functions to make it accessible to both functions

function stopClock(){
    rotateClockHand = setInterval(clockTick, 1000); // Assign the interval ID to the variable
}

const stopButton = document.getElementById('stopButton'); // Assuming the stopButton element exists in the HTML
...
const startButton = document.getElementById('startButton'); // Assuming the startButton element exists in the HTML
