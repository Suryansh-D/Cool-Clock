...
let initiate_clock = function(){
    let second_hand = document.querySelectorbyId('#second_hand');
    let minute_hand = document.querySelectorbyId('#minute_hand');
    let hour_hand = document.querySelectorbyID('#hour_hand');
